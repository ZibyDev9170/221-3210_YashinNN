...
public:
    ...
    void setupUi(QWidget *ListItem)
    {
        ...
        passwordLineEdit->setMinimumSize(QSize(160, 40));
        passwordLineEdit->setMaximumSize(QSize(200, 16777215));
        passwordLineEdit->setFont(font1);
        passwordLineEdit->setStyleSheet(QString::fromUtf8("color: rgb(23, 0, 194);"));
